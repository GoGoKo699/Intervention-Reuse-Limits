...
[Verification](docs/VERIFICATION.md) records the full suite and its limits. The certificates bound entire error boxes and fixed comparison models; they do not optimize over rival generators. The next scientific priorities are independently supported preparation and initial-readout conditions for the charge candidate, and robust treatment of departures from its stipulated heat-bath rates. The weaker-field design already improves the observable separation and crosses the old design's sampling lower bound; further tuning of sampling constants is secondary to those physical questions. The remaining measurement burden and instrument assumptions are obstacles to physical significance. Manuscript drafting remains deferred.
