...
This note proves the direct finite-horizon scalar proposition used in the main separation. The separate [observable aggregation rigidity theorem](OBSERVABLE_AGGREGATION_RIGIDITY.md) uses preparation calibration to control feature losses under a specified projection architecture.
