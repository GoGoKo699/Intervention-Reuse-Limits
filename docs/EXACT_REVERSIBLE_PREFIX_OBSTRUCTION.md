...
[Checkpoint](../README.md) · [Source comparison](PRIOR_ART.md)

**Research theorem, 22 September 2026.** [Exact finite checks](../scripts/verify_exact_reversible_prefix_obstruction.py) and [their generated report](../reports/exact_reversible_prefix_obstruction.json) supplement the proof below.
