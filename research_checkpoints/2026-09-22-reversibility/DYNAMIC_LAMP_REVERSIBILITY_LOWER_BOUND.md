...
[Checkpoint and recovery status](README.md) · [Bounded-rate upper bounds](../../docs/BOUNDED_RATE_FINITE_FIELD.md) · [Positive transport repair](POSITIVE_TRANSPORT_REPAIR.md) · [Fixed-clock transfer](REVERSIBLE_WORD_OBSERVABILITY.md)
...
This archival text recovers the inspected and internally audited proof after a workspace disconnection. It is not a claim that the unfinished new mathematical verification suite ran successfully. The checkpoint index records that distinction.
...
The [bounded-rate word construction](../../docs/BOUNDED_RATE_FINITE_FIELD.md) with $m=19$ and target cap $3$ uses $P=I+K/3$ and internal Poisson update rate $3$. It gives a stationary, possibly nonreversible surrogate with the original field rule, exact histogram and exits at most $3$, satisfying
